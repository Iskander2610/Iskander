...
export const russianSoundNames = [
  'Вомп вниз', 'Бонк вниз', 'Инопланетный рост', 'Прыг вверх', 'Провал вниз',
  'Двойной бонк', 'Шум', 'Сирена', 'Скольжение вниз', 'Бас шаги',
  'Лазер вверх', 'Робот бип', 'Медленный рост', 'Грустный спад', 'Мини шум',
  'Аркадный прыжок', 'Зап падение', 'Мем круг', 'Ровный гудок', 'Быстро вниз',
] as const;
